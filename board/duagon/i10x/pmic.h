...
#define PMIC_OP_REG_SEL_1_1 			(0x2B)	/* 1.1 V */
...
#define PMIC_DEVCTRL_CK32K_CTRL_EXTCLK (0xdf) /*0b1101_1111 */
#define PMIC_DEVCTRL_CK32K_CTRL_RC     (0x1 << 5)
#define PMIC_DEVCTRL_RTC_PWDN_POWERED  (0xbf) /* 0b1011_1111 */
#define PMIC_DEVCTRL_RTC_PWDN_PWDN     (0x1 << 6)

/* RTC register addresses */
#define RTC_SECONDS_REG_ADDR      0x0
#define RTC_MINUTES_REG_ADDR      0x1
#define RTC_HOURS_REG_ADDR        0x2
#define RTC_DAYS_REG_ADDR         0x3
#define RTC_MONTHS_REG_ADDR       0x4
#define RTC_YEARS_REG_ADDR        0x5
#define RTC_WEEKS_REG_ADDR        0x6
#define RTC_CTRL_REG_ADDR         0x10
#define RTC_STATUS_REG_ADDR       0x11

#define RTC_BCK1_REG_ADDR       0x17 /* Used to store information about pmic date already set (detect battery good) */
#define RTC_BCK2_REG_ADDR       0x18
#define RTC_BCK3_REG_ADDR       0x19
#define RTC_BCK4_REG_ADDR       0x1a
#define RTC_BCK5_REG_ADDR       0x1b
